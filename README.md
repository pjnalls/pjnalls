...
I'm an MSIT postgraduate (Master of Science in Information Technology) at UoPeople (the University of the People), deeply curious about the challenges of technological and psychological integration within society.<br/>
Currently, as a software engineer and tutor, I primarily code in React Native, NativeWind, and TypeScript, building cross-platform Expo apps for iOS, Android, and the Web.

I strive to create "human-centered UI," ensuring technology enhances the user experience. <br/> My belief in "user-owned data" stems from a deep respect for individual autonomy and the ethical use of information. I believe in a future where technology fosters genuine connections and does not incite prejudice, discrimination, or conflict.

Beyond coding, I spend most of my free time in introspection and scientific observation of the internal and external worlds within the human experience, usually striving to reconcile the fragmented collective and individual human psyche with the ever-accelerating integration of technological advancements. I share my discoveries on my blog available at [pjnalls.github.io](https://pjnalls.github.io/blog/).

I'm also dedicated to bridging cultural gaps. As a tutor on Preply, I share my love of language, guiding students toward fluency. My JLPT N2 certification and extensive Mandarin coursework reflect my commitment to multilingualism and cross-cultural understanding. Speaking English, Japanese, and Mandarin (at a B1 level) along with some Spanish allows me to connect with diverse communities and contribute to a more interconnected world.
